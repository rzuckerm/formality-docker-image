FORMALITY_VERSION := $(shell cat FORMALITY_VERSION)
FORMALITY_DEPS := $(wildcard FORMALITY_*)
DOCKER_TAG_PREFIX := rzuckerm/formality:$(FORMALITY_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FORMALITY_DEPS)
